        ...
        <div className="main-content">
          <div className="top-section">
            <h1 className="main-title">
              {courseData ? courseData.subject.name : "Cargando curso..."}
            </h1>
              ...
              >
                {courseData ? (
                  <>
                    <p>
                      Bienvenido al curso:{" "}
                      <strong>{courseData.subject.name}</strong>
                    </p>

                    <h3 style={{ marginTop: "2rem" }}>Módulos del curso:</h3>
                    {modules.length > 0 ? (
                      <div
                        style={{
                          display: "flex",
  ...
  >
    Crear material
                                ...
                                <li
                                  ...
                                  onClick={() => {
                                    alert(`Crear evaluación en módulo ${mod.id}`);
                                    setOpenMenuId(null);
                                  }}
                                >
                                  Crear evaluación
                                ...
                                <li
                                  ...
                                  onClick={() => {
                                    alert(`Crear tarea en módulo ${mod.id}`);
                                    setOpenMenuId(null);
                                  }}
                                >
                                  Crear tarea
                                ...
                                <li
                                  ...
                                  onClick={() => {
                                    alert(`Crear foro en módulo ${mod.id}`);
                                    setOpenMenuId(null);
                                  }}
                                >
                                  Crear foro
                      ...
                      <p>No hay módulos registrados para este curso.</p>
                    )}
                  </>
                ) : (
